...
podman run --rm -v "${HOME}/Development/diffusers:/root/Development:cached" -it -h "drmbth-training-dev" gabr1elt/dreambooth-training-dev
# use gpu (CDI)
podman run --device nvidia.com/gpu=all --rm -v "${HOME}/Development/diffusers:/root/Development:cached" -it -h "drmbth-training-dev" gabr1elt/dreambooth-training-dev
